        ...
        <div class="row ">
          <div class="col-md-4">
            <div class="post-entry">
              <img src="{{ asset('frontend-assets/images/img_3.jpg')}}" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <img src="{{ asset('frontend-assets/images/img_6.jpg')}}" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <img src="{{ asset('frontend-assets/images/img_5.jpg')}}" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
