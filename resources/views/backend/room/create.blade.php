                  ...
                  <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('rooms.store') }}">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('capacity') is-invalid @enderror" name="capacity" id="capacity" value="{{ old('capacity') }}">
                        @error('capacity')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="number" step="0.1" class="form-control @error('room_size') is-invalid @enderror" name="room_size" id="room_size" value="{{ old('room_size') }}">
                        @error('room_size')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                    ...
                    <div class="col-md-3 mb-3">
                      <div class="card h-100">
                        ...
                        <div class="card-body text-center">
                          <input type="radio" name="selectedImage" value="{{ $image->id }}" data-img-link="{{ asset('uploads/' . $image->img_link) }}" id="image{{ $image->id }}">
